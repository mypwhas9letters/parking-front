...
const Reservation = (props) => {
  ...
  const statusButtons = props.reservation.status === "pending" ? (<div><button name="approved" value={props.reservation.id} onClick={props.onclick} className="ui primary button">Confirm</button><button name="denied" value={props.reservation.id} onClick={props.onclick} className="ui red button">Deny</button></div>) : null
  return (
    <div className="item">
